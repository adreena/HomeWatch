...
function sendAjaxPie(consumption,startDate,endDate){
           ...
           // elec_query[3]=source
           	var	tempURL="http://localhost:8888/HomeWatch/my_search/bas.php";
...
function sendAjaxStock(consumption,source,apartment,queryID){
           ...
           if(queryID=='apartment'){
           		tempURL="http://localhost:8888/HomeWatch/my_search/electricity.php";
           		query[0]=consumption;
           		query[2]=apartment;
           		query[1]=source;
           		...
           		tempURL="http://localhost:8888/HomeWatch/my_search/bas.php";
           		query[0]=queryID;
           		query[1]=apartment;
           	}
            var queryResult=$.parseJSON(
